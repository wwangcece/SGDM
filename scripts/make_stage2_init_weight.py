...
parser.add_argument("--sd_weight", type=str, default="checkpoints/v2-1_512-ema-pruned.ckpt")
parser.add_argument("--swinir_weight", type=str, default="checkpoints/general_swinir_v1.ckpt")
parser.add_argument("--output", type=str, default="checkpoints/init_weight/init_weight-refsr-w-encoder.pt")
