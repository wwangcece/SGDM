...
parser.add_argument("--cldm_config", type=str, default="configs/model/refsr_simu.yaml")
parser.add_argument("--sd_weight", type=str, default="checkpoints/v2-1_512-ema-pruned.ckpt")
parser.add_argument("--output", type=str, default="checkpoints/init_weight/init_weight-refsr-o-sgm.pt")
